...
using DragonRider.Shared.Api.DataTypes;
...
//            _player = new Player(
//                game,
//                new Vector2((33 * Constants.PixelsPerUnit), (15 * Constants.PixelsPerUnit)),
//                new Vector2(16, 24)
//            );
...
////                ),
////                new Vector2(
////                    ((mapWidthInTiles * Constants.PixelsPerUnit) - Constants.ViewportWidth) + (_map.WidthInPixels - _map.WidthInPixels * (1 / Game.Camera.Zoom)) / 2,
////                    ((mapHeightInTiles * Constants.PixelsPerUnit) - Constants.ViewportHeight) + (_map.HeightInPixels - _map.HeightInPixels * (1 / Game.Camera.Zoom)) / 2
////                )
////            );
////
